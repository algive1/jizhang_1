...
data class PaymentCandidate(val amountInCents: Long, val merchantRaw: String, val merchantNormalized: String, val paymentMethod: String, val timestamp: Long, val scene: PaymentScene, val amountConfidence: Double, val merchantConfidence: Double, val sourceApp: String = "WECHAT") {
