...
class CategoryIcon extends StatelessWidget {
  ...
  static const _secondaryIcons = <String, IconData>{
    ...
    '专业资料': Icons.menu_book_rounded,
    '书籍文具': Icons.menu_book_rounded,
    '乳品饮料': Icons.local_drink_rounded,
    '云服务': Icons.cloud_rounded,
    '产品销售': Icons.storefront_rounded,
    '仓储租金': Icons.warehouse_rounded,
    '会议费': Icons.groups_rounded,
    '佣金收入': Icons.handshake_rounded,
    '保证金退回': Icons.savings_rounded,
    '停车通行': Icons.local_parking_rounded,
    '兴趣班': Icons.palette_rounded,
    '其他经营支出': Icons.more_horiz_rounded,
    '其他经营收入': Icons.add_circle_rounded,
    '内容制作': Icons.video_library_rounded,
    '出差住宿': Icons.hotel_rounded,
    '出差餐饮': Icons.restaurant_rounded,
    '办公室租金': Icons.business_rounded,
    '办公用品': Icons.inventory_2_rounded,
    '办公设备': Icons.computer_rounded,
    '包装材料': Icons.inventory_2_rounded,
    '原材料': Icons.inventory_2_rounded,
    '合作伙伴礼赠': Icons.redeem_rounded,
    '合同回款': Icons.request_quote_rounded,
    '员工体检': Icons.monitor_heart_rounded,
    '员工保险': Icons.health_and_safety_rounded,
    '员工培训': Icons.school_rounded,
    '商业车险': Icons.shield_rounded,
    '商务打车': Icons.local_taxi_rounded,
    '商务机票': Icons.flight_rounded,
    '商务活动': Icons.event_rounded,
    '商品采购': Icons.shopping_cart_rounded,
    '团队建设': Icons.groups_rounded,
    '团队用餐': Icons.restaurant_rounded,
    '场地维护': Icons.handyman_rounded,
    '外包服务': Icons.handshake_rounded,
    '子女学费': Icons.school_rounded,
    '存款利息': Icons.percent_rounded,
    '客户招待': Icons.groups_rounded,
    '客户用餐': Icons.restaurant_rounded,
    '客户礼品': Icons.redeem_rounded,
    '家人工资': Icons.payments_rounded,
    '家人衣物': Icons.checkroom_rounded,
    '家庭聚餐': Icons.restaurant_rounded,
    '家庭补贴': Icons.account_balance_wallet_rounded,
    '家庭零食': Icons.fastfood_rounded,
    '展会费用': Icons.event_rounded,
    '差旅补贴': Icons.card_travel_rounded,
    '市内交通': Icons.directions_bus_rounded,
    '平台推广': Icons.campaign_rounded,
    '广告投放': Icons.campaign_rounded,
    '意外损失': Icons.warning_amber_rounded,
    '手续费': Icons.receipt_long_rounded,
    '托育托管': Icons.child_friendly_rounded,
    '投资分红': Icons.pie_chart_rounded,
    '投资处置收益': Icons.trending_up_rounded,
    '授权收入': Icons.workspace_premium_rounded,
    '服务收入': Icons.handshake_rounded,
    '杂项支出': Icons.more_horiz_rounded,
    '水电网络': Icons.wifi_rounded,
    '活动营销': Icons.campaign_rounded,
    '物业费': Icons.apartment_rounded,
    '福利补助': Icons.favorite_rounded,
    '租赁收入': Icons.key_rounded,
    '税费': Icons.receipt_long_rounded,
    '签证保险': Icons.shield_rounded,
    '米面粮油': Icons.local_grocery_store_rounded,
    '经营手续费': Icons.receipt_long_rounded,
    '经营损失': Icons.warning_amber_rounded,
    '经营补贴': Icons.account_balance_wallet_rounded,
    '绩效收入': Icons.trending_up_rounded,
    '节庆礼赠': Icons.redeem_rounded,
    '节日福利': Icons.celebration_rounded,
    '茶歇饮品': Icons.local_cafe_rounded,
    '设备维护': Icons.build_rounded,
    '课外辅导': Icons.cast_for_education_rounded,
    '财税服务': Icons.request_quote_rounded,
    '资产处置': Icons.sell_rounded,
    '资质认证': Icons.workspace_premium_rounded,
    '赔偿收入': Icons.account_balance_wallet_rounded,
    '车辆维修保养': Icons.car_repair_rounded,
    '运营燃油': Icons.local_gas_station_rounded,
    '退货退款': Icons.undo_rounded,
    '采购运费': Icons.local_shipping_rounded,
    '银行手续费': Icons.account_balance_rounded,
    '销售返利': Icons.savings_rounded,
    '高铁火车': Icons.train_rounded,
  };
