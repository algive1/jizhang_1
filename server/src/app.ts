...
import { registerCommercialAdminRoutes } from './admin_auth.js';
import { registerAdminUserRoutes } from './admin_users.js';
import { registerEntitlementRoutes } from './entitlements.js';
import { registerReleaseControlRoutes } from './release_control.js';
import { registerAiControlRoutes } from './ai_control.js';
...
export async function createApp(
  ...
  registerCommercialAdminRoutes(app,store);
  registerAdminUserRoutes(app,store);
  registerEntitlementRoutes(app,store);
  registerReleaseControlRoutes(app,store);
  registerAiControlRoutes(app,store);
